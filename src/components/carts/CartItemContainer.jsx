...
function CartItemContainer({ cartItem, setIsLoading }) {
    ...
    return (
        <>
            {
                product ? (<div className="w-full md:w-[70%] bg-gray-300 rounded-lg flex flex-col md:flex-row items-center justify-between gap-4 p-4 hover:shadow-lg transition-all duration-300">
                    {/* IMAGE */}
                    ...
                    <div className="w-full bg-red-100 text-red-600 p-4 rounded-md text-center">
                        ไม่พบข้อมูลสินค้าในตะกร้านี้
                    </div>
                )
            }
        </>
